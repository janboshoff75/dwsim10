...
namespace DWSIM.Automation.FluentAPI.Builders
{
    ...
    public sealed class DistillationColumnBuilder : UnitOpBuilder<DistillationColumn, DistillationColumnBuilder>
    {
        ...
        /// <summary>Sets <c>Temperature Relaxation</c> of the bubble-point solvers (0 to 1, default 0.5) and returns this builder for chaining.</summary>
        public DistillationColumnBuilder WithTemperatureRelaxation(double fraction) { Object.TemperatureRelaxation = fraction; return this; }
